...
Defense = FootballData(2019).DefenseData(1,8)
DefenseSummary = FootballData(2019).DefenseSummary(1,8)
NFLStats = FootballData(2019).YearData(1,8)
NFLSummary = FootballData(2019).PlayerSummary(1,8)
